...
export default function PTContacts() {
    ...
    const products = [
      {
          ...
          OtherEmail: 'jackson.graham@example.com',
          PrelimCredInst: 'CGU',
          Cred: 'Other',
          ISP: 'Ava Erby',
          CCS: 'CCS',
    ...
    {     id: "487442",
        ...
        OtherEmail: 'alma.lawson@example.com',
        PrelimCredInst: 'CGU',
        Cred: 'Other',
        ISP: 'Ava Erby',
        CCS: 'CCS',
    ...
    const IntroEmailBody = (rowData) => {
        return <>
        <div className='flex justify-center w-full'> <Checkbox onChange={e => setChecked(e.checked)} checked={checked}></Checkbox> <i className=''></i></div>
        </>;
    };
            ...
            <div className="bg-white border border-[#F2EEEE] rounded-lg xl:rounded-[0.521vw] dark:bg-[#13161B] dark:border-[#1F2A37]">
                    <div className="flex items-center justify-between xl:px-[1.042vw] px-4 xl:pt-[1.042vw] pt-4 xl:pb-[0.990vw] pb-4 border-b border-b-[#F2EEEE] dark:border-b-[#1F2A37]">
                        <div className="flex flex-wrap items-center xl:gap-[0.521vw] gap-2">
                            <div className="text-[#262626] xl:text-[0.833vw] text-sm font-medium xl:leading-[1.042vw] leading-5 dark:text-[#fff]">PT Contacts</div>
                    ...
                    >
                        ...
                        ></Column>
                        <Column
                            field="PrelimCredInst"
                            header="PrelimCredInst"
                            showFilterMatchModes={false}
                            showFilterMenuOptions={false}
                            showClearButton={false}
                            showApplyButton={false}
