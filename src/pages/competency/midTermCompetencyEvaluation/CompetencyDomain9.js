          ...
          >
            <Accordion className="competency-accordion">
              <AccordionTab
                header={
                  <CustomHeader
                    label="Recognize and Acknowledge Bias in Curriculum & Media"
                    label2="Strand 1.1"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Promote Comparative, Critical, and Global Perspectives"
                    label2="Strand 1.2"
                  />
                }
              >
...
export default ComepetencyDomain9;
