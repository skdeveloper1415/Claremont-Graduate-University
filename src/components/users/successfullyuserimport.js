...
const SuccessfullyUserImported = (props) => {    
    ...
    return (
        <>
            <div>
                <Sidebar visible={props.visible} position="right" style={{background:'#FCF5F6'}}
                ...
                <div className="xl:px-[2.604vw] px-10 xl:space-y-[1.875vw] space-y-8">
                    ...
                    <div className="text-center text-[#262626] xl:text-[1.354vw] text-2xl font-normal xl:leading-[1.667vw] leading-8">Successfully Imported!</div>
                    </div>
...
export default SuccessfullyUserImported;