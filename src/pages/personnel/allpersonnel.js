...
export default function AllPersonnel() {
    ...
    const GradeList = [
        { name: "Degress", code: "NY" },
        { name: "Area of Exprience", code: "RM" },
        { name: "Language", code: "RM" },
      ];
                ...
                <div className="bg-white border border-[#F2EEEE] rounded-lg xl:rounded-[0.521vw] dark:bg-[#13161B] dark:border-[#1F2A37]">
                    <div className="flex items-center justify-between xl:px-[1.042vw] px-4 xl:pt-[1.042vw] pt-4 xl:pb-[0.990vw] pb-4 border-b border-b-[#F2EEEE] dark:border-b-[#1F2A37]">
                        <div className="flex flex-wrap items-center xl:gap-[0.521vw] gap-2">
                            <div className="text-[#262626] xl:text-[0.833vw] text-sm font-medium xl:leading-[1.042vw] leading-5 dark:text-[#fff]">View Personnel</div>
                        ...
                        <div className="flex flex-wrap items-center xl:gap-[1.250vw] gap-5">
                            <div className='custom_search'>
                                <span className="p-input-icon-left">
                                    <i className="pi pi-search" />
                                    <InputText placeholder="Search" className="xl:h-[2.083vw] h-[36px] xl:w-[16.927vw]" style={{ borderRadius: '8px' }} />
                                </span>
                            </div>
                            <div className="custInput flex gap-2 items-center">
                                <div className='text-[#9CA1AB] font-normal xl:text-[0.729vw] text-xs  w-[100px] dark:text-[#9CA1AB]'>View by</div>
                                <Dropdown
                                    value={grade}
