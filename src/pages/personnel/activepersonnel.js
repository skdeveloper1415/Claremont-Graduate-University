...
export default function ActivePersonnel() {
                ...
                <div className="bg-white border border-[#F2EEEE] rounded-lg xl:rounded-[0.521vw] dark:bg-[#13161B] dark:border-[#1F2A37] ">
                    <div className="flex items-center justify-between xl:px-[1.042vw] px-4 xl:pt-[1.042vw] pt-4 xl:pb-[0.990vw] pb-4 border-b border-b-[#F2EEEE] dark:border-b-[#1F2A37]">
                        <div className="flex flex-wrap items-center xl:gap-[0.521vw] gap-2">
                            <div className="text-[#262626] xl:text-[0.833vw] text-sm font-medium xl:leading-[1.042vw] leading-5 dark:text-[#fff]">Overall Programs</div>
                    ...
                    <div className='px-[20px] xl:px-[1.042vw] py-[8px]'>
                        <div className='flex items-center gap-2'>
                            ...
                            <div className='text-[12px] xl:text-[0.625vw] px-[12px] xl:px-[0.625vw] py-[8px] xl:py-[0.417vw] rounded-[6px] cursor-pointer text-[#424242] bg-[#fff] border border-[#EAE0E0] font-normal leading-tight dark:bg-[#13161B] dark:border-[#374151] dark:text-[#AAAAAA]'>Faculty</div>
                            <div className='text-[12px] xl:text-[0.625vw] px-[12px] xl:px-[0.625vw] py-[8px] xl:py-[0.417vw] rounded-[6px] cursor-pointer text-[#424242] bg-[#fff] border border-[#EAE0E0] font-normal leading-tight dark:bg-[#13161B] dark:border-[#374151] dark:text-[#AAAAAA]'>Mentor Teachers</div>
                            <div className='text-[12px] xl:text-[0.625vw] px-[12px] xl:px-[0.625vw] py-[8px] xl:py-[0.417vw] rounded-[6px] cursor-pointer text-[#424242] bg-[#fff] border border-[#EAE0E0] font-normal leading-tight dark:bg-[#13161B] dark:border-[#374151] dark:text-[#AAAAAA]'>Staff</div>
                        </div>
                    </div>
