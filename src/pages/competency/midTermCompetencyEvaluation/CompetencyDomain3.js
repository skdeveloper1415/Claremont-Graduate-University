    ...
    <>
      <div className={myNotoSerifGeorgian.className}>
        <div className="flex gap-4">
          ...
          Relationships: Candidate’s, Content, Self
          </p>
        </div>
      </div>
          ...
          >
            <Accordion className="competency-accordion">
              <AccordionTab
                header={
                  <CustomHeader
                    label="Use Data to Inform Instruction"
                    label2="Strand 1.1"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Harness Instructional Cohesion"
                    label2="Strand 1.2"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Use Assessments to Promote Learning & Understanding"
                    label2="Strand 1.3"
                  />
                }
              >
...
export default ComepetencyDomain3;
