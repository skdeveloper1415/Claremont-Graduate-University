    ...
    <>
      <div className={myNotoSerifGeorgian.className}>
        <div className="flex gap-4 mb-[20px] xl:mb[1.67vw]">
          ...
          Relationships: Candidate’s, Self, Others
          </p>
        </div>
      </div>
          ...
          >
            <Accordion className="competency-accordion">
              <AccordionTab
                header={
                  <CustomHeader
                    label="Set & Demonstrate Expectations"
                    label2="Strand 1.1"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Promote and Maintain A Pro-Social, Asset-Based Classroom Ecology"
                    label2="Strand 1.2"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Use Knowledge of Candidate’s to Anticipate & Limit Unproductive Behavior"
                    label2="Strand 1.3"
                  />
                }
              >
...
export default ComepetencyDomain4;
