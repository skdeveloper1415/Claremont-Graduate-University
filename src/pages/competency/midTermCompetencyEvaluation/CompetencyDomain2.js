    ...
    <>
      ...
      <div className={myNotoSerifGeorgian.className}>
        <div className="flex gap-4 mb-[20px] xl:mb[1.67vw]">
          ...
          Relationships: Teacher, Candidate’s, Content
          </p>
        </div>
      </div>
      <div className="SidebarHeight">
        ...
        <div className="col-span-12">
          <div className="text-[16px] text-[#262626] font-medium">Progress</div>
        </div>
        <div className=" bg-white dark:bg-[#191A1E] col-span-4 border-r border-[#CFCCC3]">
          ...
          <div className="bg-[#FCF5F6] py-[6px] px-[8px] rounded flex justify-between items-center mx-4">
            <div className="text-[#888] text-xs font-medium">Total Points</div>
      ...
      >
        <Accordion className="competency-accordion">
          <AccordionTab
            header={
              <CustomHeader label="Introduce New Content & Skills in Engaging, Clear & Meaningful Ways" label2="Strand 1.1" />
            }
          >
            <DataTable
              value={products}
          ...
          <AccordionTab
            header={
              <CustomHeader
                label="Make Productive Learning Accessible"
                label2="Strand 1.2"
              />
            }
          >
          ...
          <AccordionTab
            header={
              <CustomHeader
                label="Use Instructional Practices to Grow Candidate’s Knowledge, Skills, & Understanding"
                label2="Strand 1.3"
              />
            }
          >
          ...
          <AccordionTab
            header={
              <CustomHeader
                label="Help Candidate’s Level Up with Steadily Increasing Rigor"
                label2="Strand 1.4"
              />
            }
          >
...
export default ComepetencyDomain2;
