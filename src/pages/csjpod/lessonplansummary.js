...
import { fetchCandidatesGetQuery } from "@/redux/slice/cguDashboard";
...
const LessonPlanSummary = () => {
  ...
  const CandidatesGetQueryData = useSelector(state => state.cguDashboard.CandidatesGetQuery);
console.log('CandidatesGetQueryData --->', CandidatesGetQueryData);
  ...
  const PostObsStatusData = (rowData) => {
    if (rowData.POST_OBS_STATUS === "Inprogress") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#e3a008] bg-[#fffce1] border border-[#e3a008] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw]  rounded-2xl xl:rounded-[0.833vw] gap-2">
            ...
            <div>{rowData.POST_OBS_STATUS}</div>
          </div>
        </>
      );
    } else if (rowData.POST_OBS_STATUS === "Completed") {
      return (
        <>
    ...
    } else if (rowData.POST_OBS_STATUS === "Pending") {
      return (
        <>
  ...
  const LplanStatusData = (rowData) => {
    if (rowData.L_PLAN_STATUS === "Inprogress") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#e3a008] bg-[#fffce1] border border-[#e3a008] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw]  rounded-2xl xl:rounded-[0.833vw] gap-2">
            <div className="bg-[#e3a008] h-[6px] w-[6px] rounded-full mb-[1px]"></div>
            <div>{rowData.L_PLAN_STATUS}</div>
          </div>
        </>
      );
    } else if (rowData.L_PLAN_STATUS === "Completed") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#49c57c]  bg-[#def7ec] border border-[#18b557] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw] rounded-2xl xl:rounded-[0.833vw] gap-2">
            <div className="bg-[#18b557] h-[6px] w-[6px] rounded-full mb-[1px]"></div>
    ...
    } else if (rowData.L_PLAN_STATUS === "Pending") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#f82a2a] bg-[#fde8e8] border border-[#f82a2a] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw] rounded-2xl xl:rounded-[0.833vw] gap-2">
            <div className="bg-[#f82a2a] h-[6px] w-[6px] rounded-full mb-[1px]"></div>
  ...
  const PreObsStatusData = (rowData) => {
    if (rowData.PRE_OBS_STATUS === "Inprogress") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#e3a008] bg-[#fffce1] border border-[#e3a008] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw]  rounded-2xl xl:rounded-[0.833vw] gap-2">
            <div className="bg-[#e3a008] h-[6px] w-[6px] rounded-full mb-[1px]"></div>
            <div>{rowData.PRE_OBS_STATUS}</div>
          </div>
        </>
      );
    } else if (rowData.PRE_OBS_STATUS === "Completed") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#49c57c]  bg-[#def7ec] border border-[#18b557] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw] rounded-2xl xl:rounded-[0.833vw] gap-2">
            <div className="bg-[#18b557] h-[6px] w-[6px] rounded-full mb-[1px]"></div>
    ...
    } else if (rowData.PRE_OBS_STATUS === "Pending") {
      return (
        <>
          <div className="flex items-center text-[12px] xl:text-[0.625vw] font-medium text-[#f82a2a] bg-[#fde8e8] border border-[#f82a2a] py-[4px] xl:py-[0.208vw] px-[12px] xl:px-[0.625vw] rounded-2xl xl:rounded-[0.833vw] gap-2">
            <div className="bg-[#f82a2a] h-[6px] w-[6px] rounded-full mb-[1px]"></div>
  ...
  useEffect(() => { 
    ...
    dispatch(fetchCandidatesGetQuery({
      "elasticQueryName": "",
      "filters": [],
      "dynamicColumns": [],
      "pivotConfig": [],
  ...
  return (
    <div>
      <div className="pt-[16px] xl:pt-[0.833vw] ">
        <div className="bg-white border dark:bg-[#13161B] border-[#F2EEEE] dark:border-[#1F2A37] rounded-lg xl:rounded-[0.521vw]">
          <div className="flex items-center justify-between xl:px-[1.042vw] px-4 xl:pt-[1.042vw] pt-4 xl:pb-[0.990vw] pb-4 border-b border-b-[#F2EEEE] dark:border-b-[#1F2A37]">
            <div className="flex flex-wrap items-center xl:gap-[0.521vw] gap-2">
              ...
              <div className="text-[#888888] dark:text-[#818181] xl:text-[0.625vw] text-xs font-medium xl:leading-[0.938vw] leading-5 bg-[#FCF5F6] 
              dark:bg-[#1C2026] xl:rounded-[0.938vw] rounded-2xl xl:px-[0.729vw] px-3 xl:py-[0.313vw] py-1">
          ...
          <div className="px-[20px] xl:px-[1.042vw] py-[8px]">
            <div className="flex items-center gap-2">
              ...
              <div className="text-[12px] xl:text-[0.625vw] px-[12px] xl:px-[0.625vw] py-[8px] xl:py-[0.417vw] rounded-[6px] cursor-pointer 
          ...
          >
            ...
            <Column
              field="L_PLAN_STATUS"
              header="L Plan Status"
              sortable
              body={LplanStatusData}
              style={{ minWidth: "13rem" }}
            ></Column>
            <Column
              field="PRE_OBS_STATUS"
            ...
            ></Column>
            <Column
              field="POST_OBS_STATUS"
              header="Post Obs Status"
              sortable
            ...
            <Tabs>
              <div className="grid grid-cols-12 h-full">
                <div className="col-span-12 lg:col-span-5">
                  <div ref={popupPaddingTopRef} className="bg-[#E0E0EF] h-full pt-[30px] xl:pt-[3.646vw] ">
                    <div className="px-[20px] xl:px-[3.646vw]">
                      <div ref={popupTitleRef} className="border border-[#FFFFFF] p-[28px] xl:p-[1.458vw] rounded-[16px] xl:rounded-[0.833vw]">
                        {/* row */}
