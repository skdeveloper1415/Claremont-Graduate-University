    ...
    <>
      <div className={myNotoSerifGeorgian.className}>
        <div className="flex gap-4 mb-[20px] xl:mb[1.67vw]">
          ...
          Relationships: Candidate’s, Households, Communities
          </p>
        </div>
      </div>
          ...
          >
            <Accordion className="competency-accordion">
              <AccordionTab
                header={
                  <CustomHeader
                    label="Raise Consciousness of Candidate’s Community & Cultural Wealth"
                    label2="Strand 1.1"
                  />
                }
              >
...
export default ComepetencyDomain7;
