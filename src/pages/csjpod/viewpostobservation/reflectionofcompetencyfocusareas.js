...
const ReflectionofCompetencyFocusAreas = () => {
    ...
    <>
      <div className={myNotoSerifGeorgian.className}>
        <div className="text-[#262626] text-[32px] xl:text-[1.667vw]">
            Reflection of Competency Focus Areas
        </div>
      </div>
            ...
            <div className="xl:mb-[0.833vw] mb-[16px]">
                <div className="bg-[#FCF5F6] py-[16px] xl:py-[0.833vw] px-[20px] xl:px-[1.042vw]">
                    <div className="mb-[20px] xl:mb-[1.042vw] ">
                        ...
                        Candidate: <span className="text-[14px] xl:text-[0.729vw] text-[#888888] font-medium mb-[4px]">Review the evidence collected on the observation scripting page with your Mentor/Advisor, to prepare for this:</span>
                        </div>
                        <div className="flex items-center gap-1 ">
                            <div className="h-[5px] w-[5px] bg-[#888888] rounded-full mb-[2px]"></div>
                            <div className="text-[14px] xl:text-[0.729vw] text-[#888888] font-medium mb-[4px]">Look back at your plans for meeting the focus competencies</div>
                        </div>
                        <div className="flex items-center gap-1 ">
                            <div className="h-[5px] w-[5px] bg-[#888888] rounded-full mb-[2px]"></div>
                            <div className="text-[14px] xl:text-[0.729vw] text-[#888888] font-medium mb-[4px]">Reflect on your pre-observation discussion.</div>
                        </div>
                    ...
                    <div>
                        <div className="text-[14px] xl:text-[0.729vw] text-[#262626] font-medium mb-[4px]">
                        Clinical Faculty Advisor: <span className="text-[14px] xl:text-[0.729vw] text-[#888888] font-medium mb-[4px]">Listen and respond to your candidate's thoughts to the prompts provided below, to prepare for this:</span>
                        </div>
                        <div className="flex items-center gap-1 ">
                            <div className="h-[5px] w-[5px] bg-[#888888] rounded-full mb-[2px]"></div>
                            <div className="text-[14px] xl:text-[0.729vw] text-[#888888] font-medium mb-[4px]">Review the evidence collected on the observation scripting page</div>
                        </div>
                        <div className="flex items-center gap-1 ">
                            <div className="h-[5px] w-[5px] bg-[#888888] rounded-full mb-[2px]"></div>
                            <div className="text-[14px] xl:text-[0.729vw] text-[#888888] font-medium mb-[4px]">Refer to the pre-observation discussion.</div>
                        </div>
                        <div className="custTextArea">
                        <InputTextarea 
                            value={value} 
...
export default ReflectionofCompetencyFocusAreas;
