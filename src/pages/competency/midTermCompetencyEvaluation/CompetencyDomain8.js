    ...
    <>
      <div className={myNotoSerifGeorgian.className}>
        <div className="flex gap-4 mb-[20px] xl:mb[1.67vw]">
          ...
          Relationships: Candidate’s, Others, Communities
          </p>
        </div>
      </div>
          ...
          >
            <Accordion className="competency-accordion">
              <AccordionTab
                header={
                  <CustomHeader
                    label="Raise Consciousness of Socio-Political Context"
                    label2="Strand 1.1"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Reconcile School & Personal Values, Beliefs, and Practices"
                    label2="Strand 1.2"
                  />
                }
              >
...
export default ComepetencyDomain8;
