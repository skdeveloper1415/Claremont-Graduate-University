  ...
  return (
    <div>
      <div>
        ...
        <div className="rounded-[8px] xl:rounded-[0.417vw] mt-[32px] xl:mt-[1.667vw] PersonalDetails">
          <ScrollPanel style={{ width: "100%", height: "100%" }}>
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-[20px] xl:gap-[1.042vw]">
              ...
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] grid gap-[40px] xl:gap-[2.083vw]">
                <div className="flex justify-between items-center">
                  <div className="flex gap-[8px] xl:gap-[0.417vw] items-center">
                    <div>
                    <Image src={'/assets/images/svg/video-play.svg'} alt="divider" width={20} height={20} />
                    </div>
                    <div className="text-[16px] xl:text-[0.833vw] text-[#424242] font-medium">
                      Video001.mp4
                    </div>
        ...
        <div className="mt-[32px] lg:mt-[0] bottom-[-70px] left-0 right-0">
...
export default AttachmentsScript;
