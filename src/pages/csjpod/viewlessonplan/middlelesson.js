                  ...
                  <div className="flex leading-5 text-[16px] xl:text-[0.833vw]">
                    <div className="text-[#262626] dark:text-[#FFF] font-semibold">
                      ...
                      <span className="text-[14px] xl:text-[0.729vw] text-[#888] dark:text-[#818181] font-normal">
                        How will you scaffold candidates' access to the most
                        essential, difficult, and rewarding parts of this
                        lesson? What will you do first, next, etc. Be specific.
                      </span>
                    </div>
                  </div>
                  <div className="flex leading-5 text-[12px] xl:text-[0.625vw] text-[#888] dark:text-[#818181] font-normal">
                    *Consider chunks of direct instruction and chew time,
                    modeling how to do/think/solve/plan/error correct/problem
                    solve, etc., thinking aloud, guided practice, examples &
                    non-examples, common definitions, structured group work,
                    meaningful independent work, pair shares, etc.
                  </div>
                  ...
                  <div className="flex leading-5 text-[16px] xl:text-[0.833vw]">
                    <div className="text-[#262626] dark:text-[#FFF] font-semibold">
                      ...
                      <span className="text-[14px] xl:text-[0.729vw] text-[#888] dark:text-[#818181] font-normal">
                        ...
                        contribution will candidates have during the
                        scaffolding?
                      </span>
                    </div>
                  </div>
