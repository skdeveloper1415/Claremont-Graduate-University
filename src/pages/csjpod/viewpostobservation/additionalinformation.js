            ...
            >
                <ScrollPanel style={{ width: "100%", height: "100%" }}>
                    <div className="xl:mb-[0.833vw] mb-[16px]">
                        <div className="text-[#262626] text-[14px] xl:text-[0.729vw] font-medium mb-[4px]">
                        Based on this POD cycle, what have you learned about your students' strengths and needs?
                        </div>
                        ...
                        <div className="mb-[20px] xl:mb-[1.042vw]">
                            ...
                            What are your next steps based on this POD cycle?
                            </div>

                            <div className="bg-[#FCF5F6] py-[16px] xl:py-[0.833vw] px-[20px] xl:px-[1.042vw] mb-[20px] xl:mb-[1.042vw]">
                                <div className="text-[14px] xl:text-[0.729vw] text-[#262626] font-medium mb-[4px]"> Candidate Ideas</div>
                                ...
                                <div className="text-[14px] xl:text-[0.729vw] text-[#262626] font-medium mb-[2px]">Clinical Faculty Advisor Input</div>

                                <div className="text-[12px] xl:text-[0.625vw] text-[#888888] font-medium mb-[6px]">(as summarized by candidate to make candidate’s understanding visible)</div>
                        ...
                        <div className="">
                            <div className="text-[#262626] text-[16px] xl:text-[0.833vw] font-semibold mb-[4px]">
                            Which competencies do you plan to address next? Why?
                            </div>
