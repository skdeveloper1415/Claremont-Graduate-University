        ...
        <ScrollPanel style={{ width: "100%", height: "100%" }}>
          ...
          >
            ...
            <div className="gap-[16px] xl:gap-[0.833vw] flex flex-col">
              ...
              Evidence will include PODs, products from all clinical assignments listed above, and any additional artifacts the candidate wishes to share.
                </p>
            </div>
          </div>
          {/* row */}
          ...
          >
            <div className="gap-[8px] xl:gap-[0.833vw] flex flex-col">
              ...
              <div className="flex loginInput popupcheckboxes mb-[20px] xl:mb-[1.042vw]">
                ...
                // checked={checked}
                ></Checkbox> 
                <label htmlFor="ingredient1" className="ml-[6px] text-[#4B586E] text-[14px] xl:text-[0.729vw] font-medium dark:text-[#AAA]">Remember me</label>
              </div>
...
export default CsjCompetencyGoals;
