        ...
        <>
            <div className={myNotoSerifGeorgian.className}>
                <div className="text-[#262626] text-[32px] xl:text-[1.667vw]">
                    Focus Area 1 - Pedagogy
                </div>
                <div className="text-[#888888] text-[16px] xl:text-[0.833vw] font-medium">
                    Competency 2.2 Make Productive Learning Accessible
                </div>
            </div>
                ...
                <ScrollPanel style={{ width: "100%", height: "100%" }}>
                    <div className="xl:mb-[0.833vw] mb-[16px]">
                        <div className="text-[#262626] text-[16px] xl:text-[0.833vw] font-semibold mb-[4px]">
                            Help Candidates Level Up with Steadily Increasing Rigor 1
                        </div>
                        <div className="bg-[#FCF5F6] py-[16px] xl:py-[0.833vw] px-[20px] xl:px-[1.042vw] mb-[20px] xl:mb-[1.042vw]">
                            ...
                            <div className="text-[14px] xl:text-[0.729vw] text-[#424242] font-normal mb-[12px] xl:mb-[0.625vw]">How have you approached this lesson plan differently based on past feedback from class, mentors, candidates, readings, etc.?</div>
                        ...
                        <div className="text-[#262626] text-[16px] xl:text-[0.833vw] font-semibold mb-[4px]">
                            Help Candidates Level Up with Steadily Increasing Rigor 2
                        </div>
                        <div className="bg-[#FCF5F6] py-[16px] xl:py-[0.833vw] px-[20px] xl:px-[1.042vw] mb-[20px] xl:mb-[1.042vw]">
