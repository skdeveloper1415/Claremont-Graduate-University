          ...
          >
            <Accordion className="competency-accordion">
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Establish Baseline of Respect for Candidate & Their Learning"
                    label2="Strand 1.2"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Develop Familiarity & Facility with The Curriculum"
                    label2="Strand 1.3"
                  />
                }
              >
              ...
              <AccordionTab
                header={
                  <CustomHeader
                    label="Take Responsibility for Candidate’s Learning & Engagement"
                    label2="Strand 1.4"
                  />
                }
              >
...
export default ComepetencyDomain1;
