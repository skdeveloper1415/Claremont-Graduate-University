        ...
        <div className="rounded-[8px] xl:rounded-[0.417vw] mt-[32px] xl:mt-[1.667vw] SidebarHeight">
          <ScrollPanel style={{ width: "100%", height: "100%" }}>
            <div className="grid grid-cols-2 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-[20px] xl:gap-[1.042vw]">
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] dark:bg-[#13161B] grid gap-[40px] xl:gap-[2.083vw]">
                <div className="flex justify-between items-center">
                  <div className="flex gap-[8px] xl:gap-[0.417vw] items-center">
                    <div>
                      <i
                        className="cgupod-gallery text-[#424242] dark:text-[#FFFFFF]"
                        style={{ fontSize: "1.042vw" }}
                      ></i>
                    </div>
                    <div className="text-[16px] xl:text-[0.833vw] text-[#424242] dark:text-[#FFFFFF] font-medium">
                      Image001.jpeg
                    </div>
                  </div>
                  <div>
                    <i
                      className="cgupod-three-dots dark:text-[#FFFFFF]"
                      style={{ fontSize: "0.365vw" }}
                    ></i>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex flex-col text-[12px] xl:text-[0.625vw] font-normal text-[#888] dark:text-[#818181]">
              ...
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] dark:bg-[#13161B] grid gap-[40px] xl:gap-[2.083vw]">
                <div className="flex justify-between items-center">
                  <div className="flex gap-[8px] xl:gap-[0.417vw] items-center">
                    <div>
                      <i
                        className="cgupod-gallery text-[#424242] dark:text-[#FFF]"
                        style={{ fontSize: "1.042vw" }}
                      ></i>
                    </div>
                    <div className="text-[16px] xl:text-[0.833vw] text-[#424242] dark:text-[#FFF] font-medium">
                      Image001.jpeg
                    </div>
                  </div>
                  <div>
                    <i
                      className="cgupod-three-dots dark:text-[#FFF]"
                      style={{ fontSize: "0.365vw" }}
                    ></i>
                  </div>
                </div>
                <div className="flex justify-between items-center">
                  <div className="flex flex-col dark:text-[#818181] text-[12px] xl:text-[0.625vw] font-normal text-[#888]">
                    <span>File Size : 1.8MB</span>
                    <span>Last change : 03/04/2019</span>
                  </div>
                  <div>
              ...
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] dark:bg-[#13161B] grid gap-[40px] xl:gap-[2.083vw]">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex flex-col text-[12px] dark:text-[#818181] xl:text-[0.625vw] font-normal text-[#888]">
                    <span>File Size : 1.8MB</span>
                    <span>Last change : 03/04/2019</span>
                  </div>
                  <div>
              ...
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] dark:bg-[#13161B] grid gap-[40px] xl:gap-[2.083vw]">
                ...
                <div className="flex justify-between items-center">
                  <div className="flex flex-col text-[12px] xl:text-[0.625vw] dark:text-[#818181] font-normal text-[#888]">
                    <span>File Size : 1.8MB</span>
                    <span>Last change : 03/04/2019</span>
                  </div>
                  <div>
              ...
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] dark:bg-[#13161B] grid gap-[40px] xl:gap-[2.083vw]">
                <div className="flex justify-between items-center">
                  <div className="flex gap-[8px] xl:gap-[0.417vw] dark:text-[#FFF] items-center">
                    <div>
                      <i
                        className="cgupod-document-text text-[#424242] dark:text-[#FFF]"
                        style={{ fontSize: "1.042vw" }}
                      ></i>
                    </div>
                    <div className="text-[16px] xl:text-[0.833vw] text-[#424242] dark:text-[#FFF] font-medium">
              ...
              <div className="p-[20px] xl:p-[1.042vw] rounded-lg bg-[#FFF] dark:bg-[#13161B] grid gap-[40px] xl:gap-[2.083vw]">
                <div className="flex justify-between items-center">
                  <div className="flex gap-[8px] xl:gap-[0.417vw] items-center">
                    ...
                    <div className="text-[16px] xl:text-[0.833vw] dark:text-[#FFF] text-[#424242] font-medium">
                      Image001.jpeg
                    </div>
                  </div>
                  <div>
        ...
        <div className="mt-[32px] lg:mt-[0] lg:absolute bottom-[-70px] left-0 right-0">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1">
              <Link
                href={""}
                className="flex items-center bg-white dark:bg-[#13161B] dark:border-[#F5747C] dark:text-[#F5747C] hover:bg-[#AF1E27] border border-[#AF1E27] rounded-[8px] xl:rounded-[0.417vw] text-[#AF1E27] hover:text-white text-[16px] xl:text-[0.833vw] px-[20px] xl:px-[1.042vw] py-[12px] xl:py-[0.625vw] transition ease-in-out delay-150"
              >
